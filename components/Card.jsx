        ...
        <div className="flex h-full mt-[50px] gap-[50px]">
          <div className="w-[40%] relative top-[10%]">
            ...
            <span className="flex items-center gap-[5px]">
              <a href={url} target="_blank" rel="noopener noreferrer" className="text-[12px] underline cursor-pointer">
                See more
              </a>
          ...
          <div className="w-[60%] h-full rounded-[25px] overflow-hidden relative">
            <motion.div className="w-full h-full" style={{ scale: imageScale }}>
              <Image fill src={`/assets/${src}`} alt="image" className="object-cover" />
            </motion.div>
          </div>
        </div>
      </motion.div>
